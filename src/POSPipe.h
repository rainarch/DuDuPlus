...
public:
	...
	void AddSBFeatures(Instance &instance,
                int curI,
                string curT,
                FeatureVector &fv);
	void AddCoreFeaturesSIZUKI(Instance &instance,
                int curI,
                string curT,
                FeatureVector &fv);
	void AddCoreFeaturesCN(Instance &instance,
                int curI,
                string curT,
                FeatureVector &fv);
	void AddCoreFeaturesMXPOST(Instance &instance,
                int curI,
                string curT,
                FeatureVector &fv);
	...
	void AddTagFeatures(Instance &instance,
                ...
                string curT,
                FeatureVector &fv);
	void AddTagCoreFeatures(Instance &instance,
                int curI,
                string preT,
                string curT,
                FeatureVector &fv);
	void AddTagSBFeatures(Instance &instance,
                int curI,
                string preT,
                string curT,
                FeatureVector &fv);
	void AddTagSuzukiFeatures(Instance &instance,
                int curI,
                string preT,
                string curT,
                FeatureVector &fv);
	...
	void CNWordType(string &w0, string &type);
